...
class PantauStokTengkulak extends StatefulWidget {
  const PantauStokTengkulak({Key? key}) : super(key: key);

  @override
  _PantauStokTengkulakState createState() => _PantauStokTengkulakState();
}

class _PantauStokTengkulakState extends State<PantauStokTengkulak> {
